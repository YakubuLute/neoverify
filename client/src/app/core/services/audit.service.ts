...
import { AuditEntry, AuditAction, ExportFormat } from '../../shared/models/document.models';
...
export class AuditService {
  ...
  logAuditEntry(entry: Omit<AuditEntry, 'id' | 'timestamp'>): Observable<AuditEntry> {
    return this.apiService.post<{ data: AuditEntry }>('audit/log', entry).pipe(
  ...
  getDocumentAuditTrail(
    documentId: string,
    params?: QueryParams
  ): Observable<PaginatedResponse<AuditEntry>> {
    return this.apiService.get<AuditResponse>(`audit/documents/${documentId}`, params as any).pipe(
      map((response) => response.data),
      catchError((error) => {
  ...
  getUserAuditTrail(
    ...
    return this.apiService.get<AuditResponse>(`audit/users/${userId}`, params as any).pipe(
      map((response) => response.data),
      catchError((error) => {
  ...
  getOrganizationAuditTrail(
    ...
    return this.apiService
      .get<AuditResponse>(`audit/organizations/${organizationId}`, params as any)
      .pipe(
        map((response) => response.data),
        catchError((error) => {
  ...
  searchAuditEntries(
    ...
    return this.apiService.get<AuditResponse>('audit/search', requestParams as any).pipe(
      map((response) => response.data),
      catchError((error) => {
  ...
  exportAuditTrail(
    ...
    return this.http
      .post(`${this.apiService.getBaseUrl()}/audit/export`, exportData, { responseType: 'blob' })
      .pipe(
        tap(() => {
  ...
  generateComplianceReport(params: {
    ...
    // Use HttpClient directly for blob responses
    return this.http
      .post(`${this.apiService.getBaseUrl()}/audit/compliance-report`, params, {
        responseType: 'blob',
      })
      .pipe(
        tap(() => {
    ...
    return this.apiService.post<any>('audit/cleanup', {}).pipe(
      ...
      tap((result) => {
        this.notificationService.success(
          `Audit cleanup completed. ${result.deletedEntries} entries removed.`
        );
      }),
      catchError((error) => {
